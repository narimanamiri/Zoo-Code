 ...
 *
 * This class manages the state for the marketplace view in the ViraCode extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the ViraCode extensions interface
